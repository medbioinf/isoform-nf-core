...
notes <- c(
    ...
    "",
    "Outputs:",
    "- isoform_signalp_candidates_AA.fasta: amino-acid FASTA for SignalP.",
    "- signalp_top_candidates.csv: compact table of strongest isoforms.",
...
writeLines(notes, file.path(outdir, "signalp_prepare_notes.txt"))

message("Wrote SignalP preparation outputs to: ", outdir)
